...
\section{Adaptación Topológica: Modo Reel Vertical (9:16)}
Históricamente, los motores de simulación en derivadas parciales se computan en mallas cuadradas o rectangulares panorámicas (16:9) debido a la simetría de los campos matriciales en memoria. Sin embargo, para responder a la demanda de las redes sociales modernas (TikTok, Instagram Reels, YouTube Shorts), el \textit{Cosmic-Generator} implementa un renderizador dinámico vertical (1080x1920).

Lejos de ser un simple recorte (Crop) que destruiría la información geométrica en los bordes, el Modo Reel transpone la matriz de cálculo. Las variables físicas espaciales asumen dominios alargados ($h \gg w$), obligando a los Atractores de Lorenz, los Fractales de Geometría Sagrada y los campos de Cahn-Hilliard a estirarse, colisionar y rebotar contra un lienzo confinado gravitacionalmente en el eje Y. Esto crea una sensación de vértigo y profundidad abismal, ideal para la compresión visual que requieren los dispositivos móviles, asegurando que ninguna estructura de alta energía quede fuera de cámara.
...
\subsection{Motor 6: Relatividad General (Lentes Gravitacionales y Agujero Negro)}
Este motor abandona la mecánica de fluidos para adentrarse en la astrofísica relativista, simulando la curvatura del espacio-tiempo alrededor de una singularidad supermasiva. Emplea la métrica de Schwarzschild (y aproximaciones de Kerr) para trazar el desvío de la luz proveniente de un campo estelar de fondo.
\begin{equation}
...
\textbf{Inyección de Audio:}
\begin{itemize}
    \item \textbf{Masa del Agujero Negro / Radio de Schwarzschild ($r_s$):} Se mapea directamente a la intensidad armónica y rítmica. En los clímax musicales (drops), la masa aumenta exponencialmente, expandiendo el horizonte de eventos y engullendo violentamente las estrellas y nebulosas circundantes.
    \item \textbf{Rotación del Espacio-Tiempo (Frame-Dragging):} Las frecuencias agudas inducen un momento angular ($a$) en el agujero negro, creando un vórtice rotacional en el disco de acreción que hace girar la luz y la materia en espiral hacia el abismo.
\end{itemize}
